...
const DICT = {
  nl: {
    ...
    "catgroup.fresh": "Vers",
    "catgroup.pantry": "Voorraadkast",
    "catgroup.drinks": "Dranken",
    "catgroup.nonfood": "Non-food",
    "hero.title": "Top deals deze week",
    "hero.subtitle": "De scherpste deals van deze week",
    "hero.prev": "Vorige deals",
    "hero.next": "Volgende deals",
  ...
  en: {
    ...
    "catgroup.fresh": "Fresh",
    "catgroup.pantry": "Pantry",
    "catgroup.drinks": "Drinks",
    "catgroup.nonfood": "Non-food",
    "hero.title": "Top deals this week",
    "hero.subtitle": "This week's sharpest deals",
    "hero.prev": "Previous deals",
    "hero.next": "Next deals",
